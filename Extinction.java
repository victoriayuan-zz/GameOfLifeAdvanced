...
class Colony
{
	...
	grid [5] [3] = new Obstacle ();
	grid [6] [4] = new Obstacle ();
	grid [7] [5] = new Obstacle ();
	grid [8] [6] = new Obstacle ();
	grid [9] [6] = new Obstacle ();
	grid [9] [7] = new Obstacle ();
	grid [9] [8] = new Obstacle ();
	grid [8] [9] = new Obstacle ();
	grid [7] [10] = new Obstacle ();
	grid [6] [11] = new Obstacle ();
	grid [5] [12] = new Obstacle ();
	grid [6] [13] = new Obstacle ();
	grid [7] [13] = new Obstacle ();
	grid [8] [14] = new Obstacle ();
	grid [9] [13] = new Obstacle ();
	grid [10] [14] = new Obstacle ();
	grid [11] [15] = new Obstacle ();
	grid [12] [14] = new Obstacle ();
	grid [13] [13] = new Obstacle ();
	grid [14] [12] = new Obstacle ();
	grid [15] [12] = new Obstacle ();
	grid [16] [13] = new Obstacle ();
...
{
    static Image image = loadImage ("potato3.png"); //image of zombie
...
{
    static Image male = loadImage ("potato2.png"); //Image of human
    static Image female = loadImage ("potato.png");
